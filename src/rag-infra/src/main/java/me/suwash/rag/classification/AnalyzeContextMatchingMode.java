 ...
 * 分析コンテキストマッチングモード。
 */
public enum AnalyzeContextMatchingMode implements Classification {
    /** 拡張子 */
    Extention("EXT"),
    /** 呼び出し元 */
    Invoker("INV");
    ...
    /** 区分値グループMap */
    private static final Map<String, AnalyzeContextMatchingMode[]> groupValuesMap;
    /** グループ内デフォルト区分値Map */
    private static final Map<String, AnalyzeContextMatchingMode> groupDefaultMap;
    ...
    static {
        // グループMap
        groupValuesMap = new HashMap<String, AnalyzeContextMatchingMode[]>();
        groupValuesMap.put(GROUP_DEFAULT, new AnalyzeContextMatchingMode[]{
            Extention,
            Invoker
            });

        // グループ内デフォルト値Map
        groupDefaultMap = new HashMap<String, AnalyzeContextMatchingMode>();
        groupDefaultMap.put(GROUP_DEFAULT, Extention);
     ...
     * @return デフォルト区分値
     */
    public static AnalyzeContextMatchingMode defaultValue() {
     ...
     * @return デフォルトの区分値
     */
    public static AnalyzeContextMatchingMode defaultValue(String group) {
     ...
     * @return 区分値配列
     */
    public static AnalyzeContextMatchingMode[] values(String group) {
     ...
     * @return 区分値
     */
    public static AnalyzeContextMatchingMode valueOfByDdId(String ddId) {
        for (AnalyzeContextMatchingMode curEnum : AnalyzeContextMatchingMode.values()) {
     ...
     * @return 区分値
     */
    public static AnalyzeContextMatchingMode valueOfByStoreValue(String storeValue) {
        for (AnalyzeContextMatchingMode curEnum : AnalyzeContextMatchingMode.values()) {
    ...
    public static boolean containsName(String group, String name) {
        for (AnalyzeContextMatchingMode curEnum : AnalyzeContextMatchingMode.values(group)) {
            if(curEnum.name().equals(name)) {
                return true;
            }
        }
     ...
     * @param storeValue 永続化値
     */
    private AnalyzeContextMatchingMode(String storeValue) {
