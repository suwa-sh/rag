...
public enum DataStoreType implements Classification {
    ...
    static {
        ...
        groupDefaultMap.put(GROUP_DEFAULT, File);
     ...
     * @return デフォルト区分値
     */
    public static DataStoreType defaultValue() {
     ...
     * @return デフォルトの区分値
     */
    public static DataStoreType defaultValue(String group) {
     ...
     * @return 区分値配列
     */
    public static DataStoreType[] values(String group) {
     ...
     * @param storeValue 永続化値
     */
    private DataStoreType(String storeValue) {
