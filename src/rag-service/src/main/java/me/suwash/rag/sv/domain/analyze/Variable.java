...
public class Variable {
    ...
    public String getValue() {
        if (VariableType.Primitive.equals(variableType)) {
            ...
            throw new SvLayerException("Sv.E0007", new Object[] {this.type + " " + this.name, VariableType.Reference.ddId()});
        }
    }
    ...
    public Variable getReferenceValue(String name) {
        if (VariableType.Reference.equals(variableType)) {
            ...
            // プリミティブ型の場合、エラー
            throw new SvLayerException("Sv.E0007", new Object[] {this.type + " " + this.name, VariableType.Primitive.ddId()});
        }
    }
